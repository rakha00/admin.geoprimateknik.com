    ...
    return $table
        ->columns([
            TextColumn::make('tanggal')
                ->label('Tanggal')
                ->getStateUsing(fn($record) => $record->pajak->tanggal ?? $record->nonPajak->tanggal ?? '-')
                ->date(),
            ...
            TextColumn::make('invoice')
                ...
                ->getStateUsing(fn($record) => 
                    ...
                    ?? ($record->nonPajak ? $record->nonPajak->no_invoice_non_pajak : '-')
                ),
        ...
        ->modifyQueryUsing(fn(Builder $query) =>
            $query->with(['pajak.details', 'nonPajak.details'])
        )
->filters([
